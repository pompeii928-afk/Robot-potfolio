...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'youtube.visit': '채널 바로가기',
    'youtube.share': '공유',
    'youtube.copied': '복사됨!',
    'youtube.copyLink': '채널 링크 복사',
    'youtube.addBtn': '+ 영상 추가',
  ...
  en: {
    ...
    'youtube.catCompetition': 'Competition',
    'youtube.catAlgorithm': 'Algorithm & Control',
    'youtube.catHardware': 'Hardware & Build',
