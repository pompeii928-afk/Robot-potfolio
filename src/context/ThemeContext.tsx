...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'checkin.checkoutBtn': '체크아웃 (퇴장하기)',
    'checkin.checkoutConfirm': '체크아웃하시겠습니까? 퇴장 기록이 저장됩니다.',
    'checkin.checkoutSuccess': '체크아웃이 완료되었습니다. 방문해 주셔서 감사합니다!',
    'checkin.checkingOut': '체크아웃 처리 중...',
    'checkin.statusActive': '방문 중 (체류 중)',
    'checkin.statusCheckedOut': '체크아웃 완료',
    'checkin.stayDuration': '체류 시간',
    'checkin.checkedInAt': '체크인 시간',
    'checkin.checkedOutAt': '체크아웃 시간',
    'checkin.continueExplore': '포트폴리오 계속 보기',
    'checkin.skipAndExplore': '체크인 없이 포트폴리오 바로 둘러보기',
    ...
    'admin.activeVisitors': '현재 체류 중',
    'admin.checkedOutVisitors': '체크아웃 완료',
    'admin.filterAllRel': '전체 방문 구분',
    'admin.filterAllStatus': '전체 상태',
    'admin.filterActive': '현재 방문 중',
    'admin.filterCheckedOut': '체크아웃 완료',
  ...
  en: {
    ...
    'checkin.checkoutConfirm': 'Are you sure you want to check out? Your departure time will be logged.',
    'checkin.checkoutSuccess': 'Checked out successfully. Thank you for visiting!',
    'checkin.checkingOut': 'Checking out...',
    'checkin.statusActive': 'Currently Visiting',
    'checkin.statusCheckedOut': 'Checked Out',
    'checkin.stayDuration': 'Visit Duration',
    'checkin.checkedInAt': 'Check-in Time',
    'checkin.checkedOutAt': 'Check-out Time',
    'checkin.continueExplore': 'Continue Exploring',
    'checkin.skipAndExplore': 'Explore portfolio without check-in',
    ...
    'admin.checkedOutVisitors': 'Checked Out',
    'admin.filterAllRel': 'All Categories',
    'admin.filterAllStatus': 'All Statuses',
    'admin.filterActive': 'Active Visitors',
    'admin.filterCheckedOut': 'Checked Out',
  ...
  ja: {
    ...
    'checkin.checkoutBtn': 'チェックアウト (退出)',
    'checkin.checkoutConfirm': 'チェックアウトしますか？退出記録が保存されます。',
    'checkin.checkoutSuccess': 'チェックアウトが完了しました。ご訪問ありがとうございました！',
    'checkin.checkingOut': 'チェックアウト処理中...',
    'checkin.statusActive': '訪問・滞在中',
    'checkin.statusCheckedOut': 'チェックアウト済',
    'checkin.stayDuration': '滞在時間',
    'checkin.checkedInAt': 'チェックイン日時',
    'checkin.checkedOutAt': 'チェックアウト日時',
    'checkin.continueExplore': 'ポートフォリオを引き続き閲覧',
    ...
    'admin.activeVisitors': '現在滞在中',
    'admin.checkedOutVisitors': 'チェックアウト済',
    'admin.filterAllRel': 'すべての区分',
    'admin.filterAllStatus': 'すべての状態',
    'admin.filterActive': '現在滞在中',
    'admin.filterCheckedOut': 'チェックアウト済',
  ...
  zh: {
    ...
    'checkin.checkoutBtn': '签退 (离开)',
    'checkin.checkoutConfirm': '确定要签退吗？将保存您的离开记录。',
    'checkin.checkoutSuccess': '签退成功，感谢您的到访！',
    'checkin.checkingOut': '正在办理签退...',
    'checkin.statusActive': '正在访问中',
    'checkin.statusCheckedOut': '已签退',
    'checkin.stayDuration': '停留时长',
    'checkin.checkedInAt': '签到时间',
    'checkin.checkedOutAt': '签退时间',
    'checkin.continueExplore': '继续浏览作品集',
    ...
    'admin.withMsg': '附带寄语',
    'admin.activeVisitors': '当前停留中',
    'admin.checkedOutVisitors': '已完成签退',
    'admin.filterAllRel': '全部访问类别',
    'admin.filterAllStatus': '全部状态',
    'admin.filterActive': '正在访问',
    'admin.filterCheckedOut': '已签退',
  ...
  es: {
    ...
    'checkin.checkoutBtn': 'Registrar salida (Check-out)',
    'checkin.checkoutConfirm': '¿Deseas registrar tu salida? Se guardará la hora de partida.',
    'checkin.checkoutSuccess': '¡Salida registrada con éxito! ¡Gracias por tu visita!',
    'checkin.checkingOut': 'Procesando salida...',
    'checkin.statusActive': 'Visitando actualmente',
    'checkin.statusCheckedOut': 'Salida registrada',
    'checkin.stayDuration': 'Duración de la visita',
    'checkin.checkedInAt': 'Hora de entrada',
    'checkin.checkedOutAt': 'Hora de salida',
    'checkin.continueExplore': 'Continuar explorando',
    ...
    'admin.activeVisitors': 'Visitando actualmente',
    'admin.checkedOutVisitors': 'Salida registrada',
    'admin.filterAllRel': 'Todas las categorías',
    'admin.filterAllStatus': 'Todos los estados',
    'admin.filterActive': 'Visitando actualmente',
    'admin.filterCheckedOut': 'Salida completada',
  ...
  de: {
    ...
    'checkin.checkoutBtn': 'Auschecken (Verlassen)',
    'checkin.checkoutConfirm': 'Möchten Sie auschecken? Ihre Verweildauer wird gespeichert.',
    'checkin.checkoutSuccess': 'Erfolgreich ausgecheckt. Vielen Dank für Ihren Besuch!',
    'checkin.checkingOut': 'Wird ausgecheckt...',
    'checkin.statusActive': 'Aktuell zu Besuch',
    'checkin.statusCheckedOut': 'Ausgecheckt',
    'checkin.stayDuration': 'Aufenthaltsdauer',
    'checkin.checkedInAt': 'Check-in-Zeit',
    'checkin.checkedOutAt': 'Check-out-Zeit',
    'checkin.continueExplore': 'Portfolio weiter ansehen',
    ...
    'admin.activeVisitors': 'Aktuell zu Besuch',
    'admin.checkedOutVisitors': 'Ausgecheckt',
    'admin.filterAllRel': 'Alle Kategorien',
    'admin.filterAllStatus': 'Alle Status',
    'admin.filterActive': 'Aktuell zu Besuch',
    'admin.filterCheckedOut': 'Ausgecheckt',
  ...
  fr: {
    ...
    'checkin.checkoutBtn': 'Départ (Check-out)',
    'checkin.checkoutConfirm': 'Souhaitez-vous enregistrer votre départ ? L\'heure de départ sera enregistrée.',
    'checkin.checkoutSuccess': 'Départ enregistré avec succès. Merci de votre visite !',
    'checkin.checkingOut': 'Traitement du départ...',
    'checkin.statusActive': 'Visite en cours',
    'checkin.statusCheckedOut': 'Départ enregistré',
    'checkin.stayDuration': 'Durée de la visite',
    'checkin.checkedInAt': 'Heure d\'arrivée',
    'checkin.checkedOutAt': 'Heure de départ',
    'checkin.continueExplore': 'Continuer à explorer',
    ...
    'admin.activeVisitors': 'Visite en cours',
    'admin.checkedOutVisitors': 'Départs enregistrés',
    'admin.filterAllRel': 'Toutes catégories',
    'admin.filterAllStatus': 'Tous les statuts',
    'admin.filterActive': 'Visite en cours',
    'admin.filterCheckedOut': 'Départ enregistré',
